  ...
  group('PersonAccount', () {
    test('fromJson and toJson should work correctly with all fields', () {
      var personAccount = PersonAccount(
        ...
        availableBalance: AmountValue(value: 6000.0, currency: 'USD', unit: 'Dollars'),
        lockingStatus: 'Locked',
        lockingReasons: ['reason1', 'reason2'],
        accountLimit: AmountValue(value: 10000.0, currency: 'USD', unit: 'Dollars'),
        personId: 'person1',
      ...
      expect(fromJson.balance!.currency, equals(personAccount.balance!.currency));
      ...
      expect(fromJson.spending!.currency, equals(personAccount.spending!.currency));
      ...
      expect(fromJson.availableBalance!.currency, equals(personAccount.availableBalance!.currency));
      expect(fromJson.availableBalance!.value, equals(personAccount.availableBalance!.value));
      expect(fromJson.availableBalance!.unit, equals(personAccount.availableBalance!.unit));
      ...
      expect(fromJson.accountLimit!.currency, equals(personAccount.accountLimit!.currency));
      expect(fromJson.accountLimit!.value, equals(personAccount.accountLimit!.value));
      expect(fromJson.accountLimit!.unit, equals(personAccount.accountLimit!.unit));
