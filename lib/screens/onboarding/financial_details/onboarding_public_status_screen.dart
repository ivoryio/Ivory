  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, OnboardingFinancialDetailsViewModel>(
      ...
      onWillChange: (previousViewModel, newViewModel) {
        if (!previousViewModel!.isMaritalStatusSelected && newViewModel.isMaritalStatusSelected) {
                    ...
                    children: [
                      ...
                      IvorySelectOption(
                        ...
                        options: [
                          ...
                          SelectOption(
                              textLabel: 'Prefer not to say', value: OnboardingMaritalStatus.preferNotToSay.name),
                        ],
                      ),
                      const SizedBox(height: 24),
                      IvorySelectOption(
                        ...
                        options: [
                          ...
                          SelectOption(
                              textLabel: 'I live in a rented home', value: OnboardingLivingSituation.rent.name),
                          SelectOption(
                              textLabel: 'I live with my parents', value: OnboardingLivingSituation.parents.name),
                        ],
                      ),
                      const SizedBox(height: 24),
                      IvoryTextField(
                            ...
                            onPressed: _continueButtonController.isEnabled
                                ? () {
                                    StoreProvider.of<AppState>(context).dispatch(CreatePublicStatusCommandAction(
                                      ...
                                      livingAttributes: OnboardingLivingSituation.values.firstWhere((element) =>
