...
class _OnboardingAddressOfResidenceScreenState extends State<OnboardingAddressOfResidenceScreen> {
  ...
  void onChanged() {
    ...
    _debounceTimer = Timer(
      ...
      () {
        if (_addressController.text.length >= 3 && _addressController.text != _previousText) {
          StoreProvider.of<AppState>(context).dispatch(
            FetchOnboardingPersonalDetailsAddressSuggestions(queryString: _addressController.text),
          );
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (viewModel is OnboardingPersonalDetailsFetchedViewModel) const Spacer(),
                          ...
                          if (viewModel is! OnboardingPersonalDetailsAddressSuggestionSelectedViewModel) const Spacer(),
                          if (viewModel is OnboardingPersonalDetailsAddressSuggestionSelectedViewModel)
