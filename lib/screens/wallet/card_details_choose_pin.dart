...
class _BankCardDetailsChoosePinScreenState
  ...
  Widget build(BuildContext context) {
    ...
    StoreConnector<AppState, BankCardActivationViewModel>(
      converter: (store) =>
      ...
      builder: (context, state) {
        // You can access your AppState using the state variable here
        return Text("Some data from state: ${state.toString()}");
      },
    );
        ...
        child: Column(
          ...
          children: [
            ...
            IvoryProgressIndicator(
              pages: const IvoryProgressIndicatorPages(
                numberOfPages: 4,
                pageNumber: 3,
              ),
            ),
