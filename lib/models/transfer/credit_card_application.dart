...
class CreditCardApplication {
  ...
  CreditCardApplication({
    ...
    required this.statementWithDetails,
    required this.inDunning,
    required this.repaymentTypeSwitchAvailableDate,
    required this.createdAt,
    required this.defaultInterestAccountId,
    required this.interestStoringAccountId,
    required this.latestRepaymentTypeSwitchDate,
    required this.qesAt,
  });
